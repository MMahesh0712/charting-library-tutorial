...
export const DEFAULT_RIGHT_OFFSET = 10;         // Right margin in candle units (broker-style: ~10 candle widths)
...
export const FUTURE_TIME_CANDLES = 15;          // Number of future whitespace points for time axis (broker-style: ~15)
